...
| E03-P2-SMOKE | 2026-08-06 | E01 application-only + 36 Bureau/Bureau Balance candidates; 5.000 train + 5.000 test | 3-fold StratifiedKFold, seed 42; fingerprint `acbcf4e4...60b5f121`; 300 estimators | Mean fold AUC: BASE `0.733400`, counts `0.735423`, amounts `0.733501`, recency `0.735712`, delinquency `0.735374`, ALL `0.734589`; pooled OOF chỉ là smoke diagnostic | [Historical feature contract](../archive/e03_bureau_legacy_screening/home_credit_bureau_features.md); [private Kaggle run v3](https://www.kaggle.com/code/tantranmanh/e03-bureau-ablation-smoke); code commit `f439d867...75ebb61e` | Completed; historical smoke diagnostic; superseded by E03-MULTITABLE Spark block pipeline; not used for current feature selection. |
| E03-SPARK-PARITY | 2026-08-09 | Spark reimplementation của pandas Bureau block `bureau-v1`; không train model | Deterministic fixture parity, full raw-data Spark smoke, rồi full local comparison với `bureau-v1`; `rtol=1e-5`, `atol=1e-6` | 305.811 rows/unique keys, 61 feature; key set, schema/order, family mapping và null mask khớp; 0 value mismatch, 0 infinity. Fixture cũng 0 mismatch (max abs diff `7,95e-08`). | [Spark candidate contract](../features/home_credit_bureau_spark.md); [private Kaggle run v3](https://www.kaggle.com/code/tantranmanh/e03-spark-bureau-parity-smoke) | Full parity PASS; đủ bằng chứng kỹ thuật để đề xuất promotion, nhưng promotion vẫn cần review/commit riêng |
| DC5-DEMO-SMOKE | 2026-08-27 | DC5 Synthetic Demo generator-v1, 100.000 dòng, seed `20260805`; M0/M1/M4 | 3-fold StratifiedKFold, seed 42; logistic backend; không so sánh City; target synthetic | OOF ROC-AUC: M0 `0.503042`, M1 `0.681157`, M4 `0.688358`; OOF PR-AUC: `0.182120`, `0.320597`, `0.330284` | Local ignored artifact `artifacts/dc5_customer_analysis/runs/b1e3b4ccf889cfbb/report.html`; [synthetic dataset card](../datasets/dc5_synthetic_demo.md) | Completed; UI/demo smoke only, không phản ánh dữ liệu FPT thật |
